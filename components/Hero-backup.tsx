   ...
   <div className="relative z-10 mx-auto flex min-h-[80vh] max-w-7xl flex-col items-center justify-between gap-16 px-8 lg:flex-row">
        ...
        >
          ...
          <p className="mt-8 text-lg leading-9 text-gray-300">
            ...
            visuals, social media content and premium motion experiences.
          </p>

          <div className="mt-10 flex gap-5">
            <button className="rounded-full bg-green-400 px-8 py-4 font-semibold text-black transition hover:scale-105">
              View Portfolio
            </button>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-5 rounded-[40px] bg-green-500/20 blur-3xl"></div>
